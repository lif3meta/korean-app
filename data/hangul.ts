...
export const consonants: HangulCharacter[] = [
  ...
  { id: 'c_s', character: 'ㅅ', romanization: 's', name: 'siot', nameKorean: '시옷', sound: '사', type: 'consonant', pronunciation: "Like 's' in 'see'. Before ㅣ, it sounds like 'sh'", examples: [{ word: '사랑', meaning: 'love', romanization: 'sarang' }, { word: '시간', meaning: 'time', romanization: 'sigan' }], order: 7 },
  ...
  { id: 'c_j', character: 'ㅈ', romanization: 'j', name: 'jieut', nameKorean: '지읒', sound: '자', type: 'consonant', pronunciation: "Like 'j' in 'just'", examples: [{ word: '자동차', meaning: 'car', romanization: 'jadongcha' }, { word: '점심', meaning: 'lunch', romanization: 'jeomsim' }], order: 9 },
  { id: 'c_ch', character: 'ㅊ', romanization: 'ch', name: 'chieut', nameKorean: '치읓', sound: '차', type: 'consonant', pronunciation: "Like 'ch' in 'church', aspirated", examples: [{ word: '차', meaning: 'tea/car', romanization: 'cha' }, { word: '친구', meaning: 'friend', romanization: 'chingu' }], order: 10 },
  ...
  { id: 'c_h', character: 'ㅎ', romanization: 'h', name: 'hieut', nameKorean: '히읗', sound: '하', type: 'consonant', pronunciation: "Like 'h' in 'hat'", examples: [{ word: '하늘', meaning: 'sky', romanization: 'haneul' }, { word: '학교', meaning: 'school', romanization: 'hakgyo' }], order: 14 },
];
...
export const doubleConsonants: HangulCharacter[] = [
  ...
  { id: 'dc_ss', character: 'ㅆ', romanization: 'ss', name: 'ssang siot', nameKorean: '쌍시옷', sound: '싸', type: 'double_consonant', pronunciation: "Tense 's' sound, stronger than regular ㅅ", examples: [{ word: '쓰다', meaning: 'to write/to use', romanization: 'sseuda' }, { word: '씨', meaning: 'seed/Mr./Ms.', romanization: 'ssi' }], order: 18 },
...
export const vowels: HangulCharacter[] = [
  ...
  { id: 'v_eu', character: 'ㅡ', romanization: 'eu', name: 'eu', nameKorean: '으', sound: '으', type: 'vowel', pronunciation: "No English equivalent. Say 'ee' but spread lips flat, unsmiling", examples: [{ word: '으른', meaning: 'adult', romanization: 'eureun' }], order: 28 },
